function NIRx2nirs(NIRx_foldername)
...
SD.MeasList = [ 1 1 1 1; 1 2 1 1; 
                2 1 1 1; 2 2 1 1; 2 3 1 1; 
                3 2 1 1; 3 3 1 1; 3 4 1 1; 
                4 3 1 1; 4 4 1 1; 4 9 1 1; 
                5 5 1 1; 5 6 1 1; 
                6 5 1 1; 6 6 1 1; 
                7 7 1 1; 7 8 1 1; 
                8 7 1 1; 8 8 1 1;
                9 4 1 1; 9 9 1 1; 9 10 1 1; 
                10 9 1 1; 10 10 1 1;
                11 11 1 1; 11 12 1 1; 
                12 11 1 1; 12 12 1 1;
                13 13 1 1; 13 14 1 1;
                ...
                3 2 1 2; 3 3 1 2; 3 4 1 2; 
                4 3 1 2; 4 4 1 2; 4 9 1 2; 
                5 5 1 2; 5 6 1 2; 
                6 5 1 2; 6 6 1 2; 
                7 7 1 2; 7 8 1 2; 
                8 7 1 2; 8 8 1 2;
                9 4 1 2; 9 9 1 2; 9 10 1 2; 
                10 9 1 2; 10 10 1 2;
                11 11 1 2; 11 12 1 2; 
                12 11 1 2; 12 12 1 2;
                13 13 1 2; 13 14 1 2;
...
d = d(:,sd_ind);
temp_test = size(d,2); 
%fprintf('The iChan is: ',temp_test);
