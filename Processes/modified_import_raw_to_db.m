function NewFiles = modified_import_raw_to_db( DataFile )
...
My_imported_options.events = sFile.events(1:3);
My_imported_options.TimeRange = sFile.prop.times;
My_imported_options.EventsTimeRange = [-10, 60];
My_imported_options.SplitRaw = 0;
My_imported_options.SplitLength = [];
My_imported_options.Resample = 0;
My_imported_options.ResampleFreq = [];
My_imported_options.RemoveBaseline = 'time'; %Baseline correction option
My_imported_options.BaselineRange = [-10,0];
